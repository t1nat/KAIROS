...
- **Purpose:** Default model id used for agent runs (primary model in the fallback chain).

- **Value (copy/paste):** `meta-llama/Llama-3.1-8B-Instruct`
...
- **Purpose:** Fallback model id, tried automatically when the primary returns 429/503 or times out.

- **Value (copy/paste):** `meta-llama/Llama-3.2-3B-Instruct`
