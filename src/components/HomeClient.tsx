                            ...
                            <div className={`flex flex-col gap-4 w-full lg:w-auto lg:min-w-[420px] justify-center ${!hasAnimated ? 'animate-smooth-fade-in' : ''}`} style={{ animationDelay: !hasAnimated ? '0.4s' : '0s' }}>
                                {showActionButtons && (
                                    <div className="surface-card p-6 space-y-4">
                                        <Link 
                                            href="/create" 
                                            className="flex items-center justify-center gap-2 px-8 py-4 font-semibold rounded-xl shadow-md hover:shadow-xl transition-all hover:scale-[1.02] text-lg group bg-gradient-to-r from-accent-primary to-accent-secondary text-white hover:opacity-90 border-transparent"
                                        >
                                            Enter Project Space
