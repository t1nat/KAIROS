// src/app/homeClient.tsx - DARK THEME VERSION
...
export function HomeClient({ hello, session }: {
    ...
    useEffect(() => {
        // Show role selection modal if user is logged in but hasn't set their role
    ...
    const handleRoleSelectionComplete = () => {
        ...
        window.location.reload(); // Refresh to show new UI
    };
        ...
        <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
                ...
                <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-6">
                        <button 
                            ...
                            className="flex items-center gap-2 px-4 py-2 text-slate-300 hover:text-white font-medium transition-all duration-200"
                        >
                            <Info size={18} />
                            About Us
                        </button>
            ...
            <section className="pt-32 pb-20 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600/20 border border-indigo-500/30 text-indigo-300 rounded-full text-sm font-medium mb-8 backdrop-blur-sm">
                        <Zap size={16} />
                    ...
                    {session ? (
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <Link 
                                href="/publish" 
                                className="inline-flex items-center gap-2 px-8 py-4 bg-slate-800 text-white font-semibold rounded-xl hover:bg-slate-700 transition-all duration-300 border-2 border-indigo-500/30 hover:border-indigo-500/50"
                            >
                                View Publications
                                <Calendar size={20} />
                            </Link>
                    ...
                    <button 
                        onClick={scrollToAbout}
                        className="mt-16 inline-flex flex-col items-center text-slate-400 hover:text-indigo-400 transition-colors animate-bounce"
                    >
            ...
            {/* About Us Section */}
            <section ref={aboutRef} className="py-20 px-6 bg-slate-800/30 backdrop-blur-xl border-y border-slate-700/50">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-16">
                        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-700/50 hover:border-indigo-500/50 transition-all duration-300 p-8">
                            <div className="w-12 h-12 bg-indigo-600/20 rounded-lg flex items-center justify-center mb-4">
                                <FolderKanban className="text-indigo-400" size={24} />
                            </div>
                            <h4 className="text-xl font-bold text-white mb-3">For Organizations</h4>
                        ...
                        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-700/50 hover:border-purple-500/50 transition-all duration-300 p-8">
                            <div className="w-12 h-12 bg-purple-600/20 rounded-lg flex items-center justify-center mb-4">
                                <Users className="text-purple-400" size={24} />
                            </div>
                            <h4 className="text-xl font-bold text-white mb-3">For Teams</h4>
                            <p className="text-slate-300">
                        ...
                        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-700/50 hover:border-blue-500/50 transition-all duration-300 p-8">
                            <div className="w-12 h-12 bg-blue-600/20 rounded-lg flex items-center justify-center mb-4">
                                <Shield className="text-blue-400" size={24} />
                            </div>
                            <h4 className="text-xl font-bold text-white mb-3">For Personal Use</h4>
                            <p className="text-slate-300">
                    ...
                    <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-700/50 p-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h5 className="font-semibold text-white mb-1">Interactive Timeline</h5>
                                    <p className="text-sm text-slate-300">Visual task management with real-time progress tracking</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <CheckCircle2 className="text-emerald-400 flex-shrink-0 mt-1" size={20} />
                                <div>
                                    <h5 className="font-semibold text-white mb-1">Document Collaboration</h5>
                                    <p className="text-sm text-slate-300">Create, edit, and draw on documents with team attribution</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <CheckCircle2 className="text-emerald-400 flex-shrink-0 mt-1" size={20} />
                                <div>
                                    <h5 className="font-semibold text-white mb-1">Password Protection</h5>
                                    <p className="text-sm text-slate-300">Secure sensitive files with encryption and email recovery</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <CheckCircle2 className="text-emerald-400 flex-shrink-0 mt-1" size={20} />
                                <div>
                                    <h5 className="font-semibold text-white mb-1">Event Publishing</h5>
                                    <p className="text-sm text-slate-300">Share events publicly or import from project workspaces</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* Role Selection Modal - Shows after login if user hasn't selected role */}
            <RoleSelectionModal 
            ...
            {isGuideOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    />
                    <div className="relative bg-slate-800 rounded-2xl shadow-2xl w-full max-w-3xl max-h-[80vh] overflow-y-auto border border-slate-700">
                        <div className="sticky top-0 bg-slate-800 border-b border-slate-700 p-6 flex justify-between items-center">
                            <h3 className="text-2xl font-bold text-white">How To Use EventFlow</h3>
                            <button 
                                onClick={() => setIsGuideOpen(false)}
                        ...
                        <div className="p-8 space-y-8">
                            <div>
                                <h4 className="text-xl font-bold text-indigo-400 mb-3">Getting Started</h4>
                            ...
                            <div>
                                <h4 className="text-xl font-bold text-indigo-400 mb-3">For Admins</h4>
                            ...
                            <div>
                                <h4 className="text-xl font-bold text-indigo-400 mb-3">For Workers</h4>
                                <ul className="list-disc list-inside space-y-2 text-slate-300">
                            ...
                            <div>
                                <h4 className="text-xl font-bold text-indigo-400 mb-3">Event Management</h4>
                                <ul className="list-disc list-inside space-y-2 text-slate-300">
