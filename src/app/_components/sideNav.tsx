...
  // Function to handle opening an existing file (kept for context)
...
      
      {/* 1. NEW DOCUMENT BUTTON: Changed to a Link to navigate */}
      <Link 
        href="/create?action=new_note" // <-- NEW: Navigate to /create with a query parameter
...
// ... (Rest of SideNav component remains the same)
