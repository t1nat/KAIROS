...
import { AccountCreateClient } from "~/components/crm/AccountCreateClient";

export default async function CrmAccountCreatePage() {
        ...
        <header className="sticky top-16 lg:top-0 z-30 topbar-solid">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-3 sm:py-4 flex flex-wrap justify-between items-center gap-3">
            <div className="flex items-center gap-3">
              <h1 className="text-xl font-bold text-fg-primary tracking-tight">{tNav("crm")}: New account</h1>
            </div>
